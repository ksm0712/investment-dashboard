...
.btn{{display:flex;align-items:center;justify-content:center;gap:12px;
  background:#fff;border:1px solid #d1d5db;border-radius:10px;padding:13px 20px;
  cursor:pointer;box-shadow:0 2px 8px rgba(15,23,42,0.06);font-size:15px;
  font-weight:700;color:#111827;font-family:Inter,sans-serif;width:100%;
  box-sizing:border-box;margin-top:-8px;}}
.btn:hover{{background:#f9fafb;}}
</style>
<div class="btn" onclick="window.location.href='{login_url}'">
